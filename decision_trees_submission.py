...
def build_decision_tree():
    """Create a decision tree capable of handling the provided data - by hand.
    ...
    root.left.left = DecisionNode(None, None, lambda data: data[2] == 0)
    root.left.right = DecisionNode(None, None, lambda data: data[2] == 0)
    root.left.left.left = DecisionNode(None, None, None, 1)
    root.left.left.right = DecisionNode(None, None, None, 0)
    root.left.right.left = DecisionNode(None, None, None, 0)
    root.left.right.right = DecisionNode(None, None, None, 1)
    return root
